...
object Constants {
    ...
    const val SEND_MESSAGE_SOCKET_EVENT = "send_message"
    const val NEW_MESSAGE_SOCKET_EVENT = "new_message"
    const val IS_TYPING_SOCKET_EVENT = "is_typing"
    const val USER_IS_TYPING_SOCKET_EVENT = "user_is_typing"
    const val LOG_OUT_USER_SOCKET_EVENT = "log_out"
